...
<div class="advertisement">
  ...
  <img src="#" class="img-responsive" alt="advertisement">
...
<div id="myCarousel" class="carousel slide" data-ride="carousel">
      ...
      <div class="carousel-inner">
        ...
        <div class="item active">
          <img src="assets/images/properties/thumbs/.jpg" class="properties" alt="properties" />
        </div>
        <!-- #Item 1 -->
...
<p class="price"><fmt:formatNumber value="" type="currency" currencySymbol="&euro;" maxFractionDigits="2"/></p>
  ...
  <p><br></p>
    ...
    <span data-toggle="tooltip" data-placement="bottom" data-original-title="Bed Room"></span> <span data-toggle="tooltip" data-placement="bottom" data-original-title="Bath Room">${pDetails.bathrooms}</span> <span data-toggle="tooltip" data-placement="bottom" data-original-title="Parking">${pDetails.garagesize}</span> <span data-toggle="tooltip" data-placement="bottom" data-original-title="Kitchen">1</span> </div>
